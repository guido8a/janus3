...
<div class="span4" style="margin-left: 200px; margin-top: 20px">
    <fieldset class="col-md-6" style="position: relative; height: 170px; float: left;padding: 10px;border-bottom: 1px solid black; border-top: 1px solid black">
        ...
        <g:uploadForm action="uploadFile" method="post" name="frmUpload" enctype="multipart/form-data">
            ...
            <div>El valor del índice a a subir al sistema debe estar en la <strong>columna D</strong> de la hoja de cálculo <br/>
