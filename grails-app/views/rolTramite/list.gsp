...
<div id="list-rolTramite" class="span12" role="main" style="margin-top: 10px;">
    ...
    <table class="table table-bordered table-striped table-condensed table-hover">
        ...
        <g:each in="${rolTramiteInstanceList}" status="i" var="rolTramiteInstance">
            <tr>
                <td>${rolTramiteInstance?.codigo}</td>
                <td>${rolTramiteInstance?.descripcion}</td>
                <td>
                    <a class="btn btn-info btn-xs btn-show" href="#"  title="Ver" data-id="${rolTramiteInstance.id}">
                        <i class="fa fa-clipboard"></i>
                    </a>
                    <a class="btn btn-success btn-xs btn-edit" href="#"  title="Editar" data-id="${rolTramiteInstance.id}">
                        <i class="fa fa-edit"></i>
                    </a>

                    <a class="btn btn-danger btn-xs btn-delete" href="#" title="Eliminar" data-id="${rolTramiteInstance.id}">
...
<script type="text/javascript">
    ...
    function submitFormRolTramite() {
        var $form = $("#frmRolTramite");
        if ($form.valid()) {
